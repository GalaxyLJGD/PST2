...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>vacuna/Consultar">Consultar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/vacuna/registrar.js"></script>
</html>