...
<html lang="es">
	...
	<body>
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					<h2>Enfermedades</h2>
					<a href="<?php echo constant('URL'); ?>enfermedad/Registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/enfermedad/consultar.js"></script>
</html>