...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>enfermedad/Consultar">Consultar</a>
				</header>

				<form id="formulario">
					<div>
						<label for="enf">Nombre de la enfermedad</label>
						<input type="text" name="enf">
					</div>				
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/enfermedad/registrar.js"></script>
</html>