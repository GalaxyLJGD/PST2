...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>representante/Registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/representante/consultar.js"></script>
</html>