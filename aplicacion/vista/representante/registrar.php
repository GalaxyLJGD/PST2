...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>representante/Consultar">Consultar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/representante/registrar.js"></script>
</html>