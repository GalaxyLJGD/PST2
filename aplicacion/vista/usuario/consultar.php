...
<html lang="es">
	...
	<body>
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					<h2>Usuarios</h2>
					<a href="<?php echo constant('URL'); ?>usuario/Registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/usuario/consultar.js"></script>
</html>