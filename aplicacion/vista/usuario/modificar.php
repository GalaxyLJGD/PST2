...
<html lang="es">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo constant('URL'); ?>publica/estilos/usuario.css">
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/usuario/modificar.js"></script>
</html>