...
<html lang="es">
	...
	<body>
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					<h2>Estados</h2>
					<a href="<?php echo constant('URL'); ?>estado/Registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/estado/consultar.js"></script>
</html>