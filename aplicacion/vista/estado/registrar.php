...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>estado/Consultar">Consultar</a>
				</header>

				<form id="formulario">
					<div>
						<label for="est">Nombre del estado</label>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/estado/registrar.js"></script>
</html>