...
<html lang="es">
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					...
					<a href="<?php echo constant('URL'); ?>escuela/Consultar">Consultar</a>
				</header>

				<form id="formulario">
					<div>
						<label for="esc">Nombre de la escuela</label>
						<input type="text" name="esc">
					</div>				
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/escuela/registrar.js"></script>
</html>