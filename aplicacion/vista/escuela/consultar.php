...
<html lang="es">
	...
	<body>
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					<h2>Escuelas</h2>
					<a href="<?php echo constant('URL'); ?>escuela/Registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/escuela/consultar.js"></script>
</html>