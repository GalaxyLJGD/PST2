...
<html lang="es">
	...
	<body>
		...
		<section class="principal">
			...
			<section class="contenido">
				<header>
					<h2>Documentos</h2>
					<a href="<?php echo constant('URL'); ?>documento/registrar">Registrar</a>
				</header>
	...
	<script type="text/javascript" src="<?php echo constant('URL'); ?>publica/librerias/documento/consultar.js"></script>
</html>